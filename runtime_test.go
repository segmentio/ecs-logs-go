...
func TestParseFuncName(t *testing.T) {
	tests := []struct {
		...
		{
			name: "github.com/segmentio/ecs-logs-go.TestLoggerPrintf",
			pkg:  "github.com/segmentio/ecs-logs-go",
			fn:   "TestLoggerPrintf",
		},
		{
			name: "github.com/segmentio/ecs-logs-go.(*Logger).Printf",
			pkg:  "github.com/segmentio/ecs-logs-go",
			fn:   "(*Logger).Printf",
		},
		{
			name: "github.com/segmentio/ecs-logs-go/apex.NewHandlerWith.func1",
			pkg:  "github.com/segmentio/ecs-logs-go/apex",
